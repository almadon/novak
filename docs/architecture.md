...
shim, [novak-integracije/memory-mcp/](../../integracije/memory-mcp/README.md), exposes Mem0 over MCP and
...
to [memory-mcp/src/mem0.ts](../../integracije/memory-mcp/src/mem0.ts). Identity resolution
